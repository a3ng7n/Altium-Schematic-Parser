...
static const int graph_center_y[N_PHILOSOPHERS] = { 76, 20,-32,-32, 20};
...
void visualize_show_startup_screen(void)
{
   ...
   graphics_draw_bitmap(canvas, _lc_ub_plate_filled_bmp, center_x-120, center_y-120+60, 240, 240, 100);
   graphics_draw_string(canvas, center_x - prog_name_size_1 / 2, 10, prog_name_1, 0, TEXT_COLOR, TEXT_TYPE);
   graphics_draw_string(canvas, center_x - prog_name_size_2 / 2, 26, prog_name_2, 0, TEXT_COLOR, TEXT_TYPE);
   graphics_set_visible_canvas(graphics, canvas); /* Refresh display */
