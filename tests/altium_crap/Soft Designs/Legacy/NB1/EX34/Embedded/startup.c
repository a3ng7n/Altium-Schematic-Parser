...
// BEM  ---- ---- ---- ---- ---- ---- -1-- ---- Byte Enable Mode
// PEN  ---- ---- ---- ---- ---- ---- --0- ---- Parity Enable
// RES  ---- ---- ---- ---- ---- ---- ---0 0000 Reserved
//-------------------------------------------------------------------------------
//      0000 0001 0000 0000 0000 0001 1100 0000
//      0    1    0    0    0    1    C    0
#define EBC_WishboneBus  0x010001C0
//-------------------------------------------------------------------------------
...
#define EBC_AMD29_Flash  0x08000000
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
void set_indirect_peripheral_register(unsigned int indirect_address, unsigned int indirect_value)
{
    __asm(
"    mtdcr   %0,%2        \n"
"    mtdcr   %1,%3        \n"
    :
    :"i"(PeripheralControl_Address),"i"(PeripheralControl_Data),"r"(indirect_address),"r"(indirect_value)
    :
    );
}
//-------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------
void set_indirect_sdram_register(unsigned int indirect_address, unsigned int indirect_value)
{
    __asm(
"    mtdcr   %0,%2        \n"
"    mtdcr   %1,%3        \n"
    :
    :"i"(SDRAMControl_Address),"i"(SDRAMControl_Data),"r"(indirect_address),"r"(indirect_value)
    :
    );
}
//-------------------------------------------------------------------------------
...
void startup(void)
{
   ...
   set_indirect_peripheral_register(EBC0_B2AP,EBC_WishboneBus);
   set_indirect_peripheral_register(EBC0_B2CR,EBC_16MB_32Bit_RAM_010);

   // 0xFF00_0000 peripheral
   set_indirect_peripheral_register(EBC0_B0AP,EBC_WishboneBus);
   set_indirect_peripheral_register(EBC0_B0CR,EBC_16MB_32Bit_RAM_FFF);

   // stop sdram
   set_indirect_sdram_register(SDRAM0_CFG,SC_SDRAM0_CFG_RESET);

   // 0x8000_0000 sdram
   set_indirect_sdram_register(SDRAM0_TR,SC_TR_CFG);
   set_indirect_sdram_register(SDRAM0_RTR,SC_RTR_3000);
   set_indirect_sdram_register(SDRAM0_B0CR,SC_64MB_32bit_SDRAM_800);

   //start sdram
   set_indirect_sdram_register(SDRAM0_CFG,SC_SDRAM0_CFG);

   // 0x7000_0000 flash
   set_indirect_peripheral_register(EBC0_B5AP,EBC_AMD29_Flash);
   set_indirect_peripheral_register(EBC0_B5CR,EBC_16MB_16Bit_Flash_700);
}
//-------------------------------------------------------------------------------
#pragma endsection
