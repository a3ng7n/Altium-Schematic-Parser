...
#define RW_DELAY       timing_delay_ns(1600)
...
//..............................................................................
unsigned char lcd_ks0066u_basic_read_ctrl(unsigned int base)
{
    unsigned char ret = 0;
    ret = ((volatile unsigned char *) base)[0];
    RW_DELAY;
    return ret;
}
//..............................................................................
...
//..............................................................................
unsigned char lcd_ks0066u_basic_read_data(unsigned int base)
{
    unsigned char ret = 0;
    ret = ((volatile unsigned char *) base)[1];
    RW_DELAY;
    return ret;
}
//..............................................................................
...
//..............................................................................
void lcd_ks0066u_basic_write_ctrl(unsigned int base, unsigned char value)
{
    ((volatile unsigned char *) base)[0] = value;
    RW_DELAY;
}
//..............................................................................

//..............................................................................
void lcd_ks0066u_basic_write_data(unsigned int base, unsigned char value)
{
...
{
  while(lcd_ks0066u_basic_read_ctrl(base) & 0x80)
  {
  }
}
...
void lcd_ks0066u_write_ctrl(unsigned int base, unsigned char c)
{
  ...
  lcd_ks0066u_basic_write_ctrl(base,c);
}
...
{
  lcd_ks0066u_wait_while_busy(base);
  lcd_ks0066u_basic_write_ctrl(base,0x01);
  timing_delay_us(1640);
}
                            ...
                            unsigned int blink)
{
  ...
  if(blink)   data |= 0x01;
  lcd_ks0066u_basic_write_ctrl(base,data);
}
...
{
    lcd_ks0066u_wait_while_busy(base);
    return lcd_ks0066u_basic_read_ctrl(base) & 0x7F;
}
                        ...
                        unsigned int *y)
{
    ...
    lcd_ks0066u_wait_while_busy(base);
    unsigned char addr;
    addr = lcd_ks0066u_basic_read_ctrl(base);
    *x = addr & 0x0F;
    *y = (addr & 0x70) >> 6;
}
...
{
  lcd_ks0066u_wait_while_busy(base);
  lcd_ks0066u_basic_write_data(base,c);
}
                                 ...
                                 unsigned char *data)
{
  ...
  addr = 0x40 + (8*charno);
  lcd_ks0066u_wait_while_busy(base);
  lcd_ks0066u_basic_write_ctrl(base,addr);
  for(i=0;i<8;i++)
  {
    lcd_ks0066u_wait_while_busy(base);
    lcd_ks0066u_basic_write_data(base,*data++);
  }
  lcd_ks0066u_wait_while_busy(base);
