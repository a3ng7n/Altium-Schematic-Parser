...
void vga_initialize_registers (void)
{
   ...
   {
      VGA_HTIM_Register  = HTIM_RegisterLowRes;
      VGA_VTIM_Register  = VTIM_RegisterLowRes;
      VGA_HVLEN_Register = HVLEN_RegisterLowRes;
      VGA_VBARa_Register = Video_DrawAddress;
   }
   else if (Video_Resolution==HighResolution)
   {
      VGA_HTIM_Register  = HTIM_RegisterHighRes;
      VGA_VTIM_Register  = VTIM_RegisterHighRes;
      VGA_HVLEN_Register = HVLEN_RegisterHighRes;
      VGA_VBARa_Register = Video_DrawAddress;
   }
   else if (Video_Resolution==LowResolutionDiv)
   {
      VGA_HTIM_Register  = HTIM_RegisterLowResDiv;
      VGA_VTIM_Register  = VTIM_RegisterLowResDiv;
      VGA_HVLEN_Register = HVLEN_RegisterLowResDiv;
      VGA_VBARa_Register = Video_DrawAddress;
      VGA_DIV_Register   = 0x1                    ;
   }
}
//..............................................................................
