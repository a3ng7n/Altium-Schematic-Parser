...
#define BASE (*((uint32_t volatile *) Base_wb_multi_manual))
...
{
    *(int16_t volatile *)(Base_wb_multi_manual +  4) = i16;
    *(int8_t volatile *) (Base_wb_multi_manual +  6) = i8;
    *(float volatile *)  (Base_wb_multi_manual +  8) = f;
    *(double volatile *) (Base_wb_multi_manual + 12) = d;
    *(char *)            (Base_wb_multi_manual + 20) = command;
}
...
{
    return *(int32_t volatile *)(Base_wb_multi_manual +  4);
}
